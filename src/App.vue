 ...
 <v-app class="grey">
  ...
  <div class="d-flex overflow-x-auto">
   <div class="d-flex flex-nowrap">
    <Column v-for="column in data" :key="column.id" :title="column.title" @add-task="addTask(column.id, $event)">
     <draggable v-model="column.tasks" :animation="200" ghost-class="ghost-card" group="tasks" :item-key="'id'">
